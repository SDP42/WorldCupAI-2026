# ✅ WorldCupAI — Phase 7 & 7.1 Approval Report

**Status**: 🏁 Phase 7.1 Complete
**Generated**: 2026-06-28 19:52:08
**Candidates**: XGBoost, Gradient Boosting, Random Forest, Extra Trees, Logistic Regression, ANN, LSTM
...
| Metric | XGBoost | Weighted Soft Voting | Delta |
|---|---|---|---|
| Accuracy | 0.6187 | 0.6151 | -0.0036 |
| ROC-AUC  | 0.7549 | 0.7547 | -0.0003 |
| Log Loss | 0.8408 | 0.8422 | -0.0015 |
